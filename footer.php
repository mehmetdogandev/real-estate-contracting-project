	...
	<div class="container pt-4">
		<div class="row">
			<div class="col-md-4">
				...
				<p class="text-light">Emlak & Müteahit - Proje, benMehmet DOĞAN'ın<br />
					Aksaray Üniversitesi, Yazılım<br />
					Mühendisliği bölümü, internet<br />
					programcılığı dersi için hazırlamış<br />
					olduğum bir proje ödevimdir.
				<p class="text-light">
					© 2021 Emlak & Müteahit - Proje</p>
				</p>
			</div>
			<div class="col-md-4">
