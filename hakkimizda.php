...
<div class="container p-5">
    ...
    <p class="text-justify p-4">Emlak Proje, ben Servet Arslan'ın Mustafa Kemal Üniversitesi, Bilgisayar Programcılığı bölümü, internet programcılığı dersi için hazırlamış olduğum bir proje ödevimdir.</p>
    <hr>
        ...
        <div class="col-md-8">
            <form action="eposta.php" method="post" name="iletisim">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputText1" placeholder="Adınızı girin" name="isim">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputText2" placeholder="Mesajınızın konusunu girin" name="konu">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Mesaj</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Bize iletmek istediğiniz mesajı girin" name="mesaj"></textarea>
                </div>
