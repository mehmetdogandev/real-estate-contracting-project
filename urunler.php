			...
			<div><!--kategoriler-->
				...
				<ul class="list-group list-group-flush">
					...
					foreach ($veri as $kayit) { ?>
						<a href="urunler.php?id=<?php echo $kayit["id"];
...
list-group-item-action<?php echo $evarsa_id == "2" ? "active" : ""; ?>">Sadece Arsa İlanları</a>
					<a href="urunler.php?evarsa_id=4<?php echo $parametre ?>" class="list-group-item
list-group-item-action<?php echo $evarsa_id == "4" ? "active" : ""; ?>">Hepsi</a>
				</div>
			</div>
			<!-- / Ev veya Arsa Listeleme -->
...
list-group-item-action<?php echo $fiyat == "8" ? "active" : ""; ?>">200.000
		...
		<div class="col-md-9">
			...
			<div class="row">
				...
				switch ($evarsa_id) {
					case '1':
						$where_evarsa_id = "evarsa_id='1'";
						break;
					case '2':
						$where_evarsa_id = "evarsa_id='2'";
						break;
					case '4':
						$where_evarsa_id = "evarsa_id='1' or evarsa_id='2'";
						break;
				}
 ...
 <span class="badge badge-success p-2 float-right"><?php // echo number_format($kayit['fiyat'], 0, ',', '.')
						...
						<div class="card mb-3" style="max-width: 940px;">
							<div class="row no-gutters">
								...
								<div class="col-md-8">
									<div class="card-body">
										<a href="urundetay.php?id=<?php echo $kayit['id'] ?>" style="color:green;">
