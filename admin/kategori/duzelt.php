...
<div class="container">
    ...
    try {
        ...
        $sorgu = "SELECT id, kategoriadi, aciklama FROM projeler_kategoriler WHERE id = ?
LIMIT 0,1";
    ...
    if ($_POST) {
        ...
        try {
            ...
            $sorgu = "UPDATE projeler_kategoriler SET kategoriadi=:kategoriadi, aciklama=:aciklama WHERE id = :id";
