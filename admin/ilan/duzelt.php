<?php  include $_SERVER['DOCUMENT_ROOT'] . '/admin/header.php';  ?>
 ...
 $sorgu = "SELECT urunler.urunadi, urunler.aciklama, urunler.fiyat, urunler.resim, urunler.resim_iki, urunler.resim_uc, urunler.resim_dort, 
 urunler.evarsa_id, urunler.kategori_id,
...
WHERE urunler.id = ? LIMIT 0,1";
 ...
 fiyat=:fiyat, resim=:resim, urunler.resim_iki=:resim_iki, urunler.resim_uc=:resim_uc, urunler.resim_dort=:resim_dort, kategori_id=:kategori_id,
...
// eğer $dosya_yukleme_hata_msj boş değilse
 ...
 <br/><br/>Yeni resim seçin: <input type="file" name="resim" /></td>
</tr>
<tr>
 <td>Resim-2</td>
 <td>
 ...
 <br/><br/>Yeni resim seçin: <input type="file" name="resim_iki" /></td>
</tr>
<tr>
 <td>Resim-3</td>
 <td>
 ...
 <br/><br/>Yeni resim seçin: <input type="file" name="resim_uc" /></td>
</tr>
<tr>
 <td>Resim-4</td>
 <td>
 ...
 <br/><br/>Yeni resim seçin: <input type="file" name="resim_dort" /></td>
</tr>
 <tr>
 <td>Başlık</td>
...
<?php
 ...
 <?php foreach ($veri as $kayit) { ?>
 <option value="<?php echo $kayit["id"] ?>"
 <?php if($kayit["id"]==$ev_kimden) echo " selected" ?>>
...
<?php
 ...
 <?php foreach ($veri as $kayit) { ?>
 <option value="<?php echo $kayit["id"] ?>"
 <?php if($kayit["id"]==$arsa_kimden) echo " selected" ?>>
 <?php echo $kayit["adsoyad"]." (Tel= ".$kayit["tel_no"].")"; ?>
 </option>
 <?php } ?>
 </select>
