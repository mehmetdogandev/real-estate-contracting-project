...
<div class="container">
	...
	$sorgu = "SELECT id, kategoriadi, aciklama FROM projeler_kategoriler WHERE kategoriadi LIKE :aranan ORDER BY id DESC LIMIT :ilk_kayit_no, :sayfa_kayit_sayisi";
		...
		<div class="row">
			<div class="col-xs-6 col-md-4 pull-right">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Kategori ara..." name="aranan" value="<?php echo isset($_GET['aranan']) ? $_GET['aranan'] : ""; ?>" />
...
class='glyphicon glyphicon glyphicon-remove-circle'></span> Sil</a>";
		...
		$sorgu = "SELECT COUNT(*) as kayit_sayisi FROM projeler_kategoriler WHERE kategoriadi LIKE :aranan";
		$stmt = $con->prepare($sorgu);
		$stmt->bindParam(":aranan", $arama_sarti);
