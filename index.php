 ...
 <div class="container pt-4">
 	...
 	<h1 class="text-center baslik">M&D EMLAK MÜTEHATİT'e Hoş Geldiniz</h1>
 	...
 	<h1 class="text-center baslik pt-4 pb-3">PROJELERİMİZ</h1>
 	<div class="row">
 		<?php
			// veritabanı yapılandırma dosyasını dahil et
			include 'config/vtabani.php';
			// kayıt listeleme sorgusu
			$sorgu = 'SELECT projeler.*, il.sehir, ilce.ilce, evarsa.ilanTuru, kategoriler.kategoriadi
 FROM projeler
 ...
 ORDER BY giris_tarihi desc LIMIT 0,3';
			...
			foreach ($veri as $kayit) { ?>
 			<div class="col-md-4 mb-4">
 				<div class="card">
 					<a style="text-decoration:none; color:#212529;" href="projedetay.php?id=<?php echo $kayit['id'] ?>">
	 ...
	 <h1 class="text-center baslik pt-4 pb-3">İlanlarımız</h1>


	<!--BURDAN SONRASI BİZİM İLANLARIMZI İÇERMEKTEDİR-->
	 <div class="row">
 		<?php
			// veritabanı yapılandırma dosyasını dahil et
			include 'config/vtabani.php';
