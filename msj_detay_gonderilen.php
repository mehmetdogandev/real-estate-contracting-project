<?php 
 ...
 if($_POST['icerik'] == ""){
	...
	$k_msj_kimden_tersi=$kayitKişiKimden['id'];
	$k_msj_kime_tersi=$kayitKişiKime['id'];
...
<div class='row justify-content-center'>
 ...
 <tr>
 <td><b>Mesaj kimden</b></td><td><?php echo $kayitKişiKimden['adsoyad']." (siz)"; ?></td>
 </tr>
 <tr>
 <td style="width:130px;"><b>Mesaj kime</b></td><td><?php echo $kayitKişiKime['adsoyad']; ?></td>
 </tr>
 <tr>
 ...
 <b><?php if($kayitGelenMesaj['k_msj_kimden'] == $k_msj_kimden){ echo "<font color='blue'>".$kayitKişiKimden['adsoyad']."</font>"; }else{ echo "<font color='green'>".$kayitKişiKime['adsoyad']."</font>"; } ?></b> 
 <br/>
 <font size="1">
 <?php 
